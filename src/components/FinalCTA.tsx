    ...
    <section id="contact" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        <motion.div
          ...
          viewport={{ once: true }}
          className="glass p-12 md:p-20 rounded-[3rem] border-primary/30 text-center relative overflow-hidden group"
        >
          ...
          <motion.div
            ...
            className="w-20 h-20 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-8 border border-primary/30"
          >
            <MessageSquare className="text-primary" size={32} />
          </motion.div>

          <h2 className="text-4xl md:text-6xl mb-8 leading-tight">
            VAMOS ESCALAR SEU <br />
            <span className="text-primary text-glow">NEGÓCIO?</span>
          </h2>
          
          <p className="text-gray-neutral text-lg md:text-xl max-w-2xl mx-auto mb-12">
