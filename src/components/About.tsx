        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl mb-8 leading-tight">
              ESTRATÉGIA QUE <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-emerald-400 font-black">TRANSFORMA</span> <br />
              DADOS EM <span className="text-emerald-400 italic">LUCRO.</span>
            </h2>
            <p className="text-gray-neutral text-lg mb-8">
              Nascemos no epicentro da revolução digital com um único propósito: destruir a mediocridade do marketing tradicional e implementar sistemas de <span className="text-primary font-bold">escala agressiva.</span>
            </p>
            <div className="flex gap-8">
              <div>
                <div className="text-3xl font-montserrat text-white mb-1">98%</div>
                <div className="text-[10px] text-primary uppercase tracking-widest">Retenção</div>
              </div>
              <div className="w-px h-12 bg-white/10" />
              <div>
                <div className="text-3xl font-montserrat text-white mb-1">10X</div>
